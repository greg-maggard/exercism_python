...
def get_rounds(number):
    ...
    round_count = 3
    round_list = [number]
    for game_round in range(round_count - 1):
        number += 1
...
def concatenate_rounds(rounds_1, rounds_2):
    ...
    """
    rounds_played = rounds_1 + rounds_2
    print(rounds_played)
...
def approx_average_is_average(hand):
    ...
    return average_first_and_last == card_average_value or middle_card == card_average_value
...
def average_even_is_average_odd(hand):
    ...
    even_averaged = card_average(even_indexed_cards)
    odd_averaged = card_average(odd_indexed_cards)
    return even_averaged == odd_averaged
...
def maybe_double_last(hand):
    ...
    """
    if hand[-1] == 11:
        doubled_jack_hand = hand[:-1] + [22]
        return doubled_jack_hand
    return hand
